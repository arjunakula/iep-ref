...
```bash
python scripts/preprocess_questions.py \
  --input_questions_json data/CLEVR_humans/CLEVR_humans-train.json \
...
python scripts/preprocess_questions.py \
  --input_questions_json data/CLEVR_humans/CLEVR_humans-val.json \
  --input_vocab_json data/human_vocab.json \
  --output_h5_file data/val_human_questions.h5 \
  --encode_unk 1
  
python scripts/preprocess_questions.py \
  --input_questions_json data/CLEVR_humans/CLEVR_humans-test.json \
  --input_vocab_json data/human_vocab.json \
